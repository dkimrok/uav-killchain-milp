...
# -*- coding: utf-8 -*-
"""
feasibility_test_v3.py  —  타당성 테스트 (v3)
==================================================
v1 대비 변경
  1. joint_model 사용: 구역 전담 정찰(recon_mode='zone')로 문제를 4개 구역
...
실행
  python feasibility_test.py                    # 셀당 1800초, 전 코어
  python feasibility_test.py 3600 16            # 제한시간, 스레드
  python feasibility_test.py 1800 16 free       # 정찰 자유이동 비교용
